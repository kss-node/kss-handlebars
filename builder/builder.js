 ...
 *
 * Note: since this builder wants to extend the KssBuilderBaseHandlebars class, it
 * must export a KssBuilderBaseHandlebars sub-class as a module.
 *
...
let KssBuilderBaseHandlebars = require('kss/builder/base/handlebars');
